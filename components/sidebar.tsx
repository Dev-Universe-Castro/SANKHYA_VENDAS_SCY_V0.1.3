  ...
  const menuItems = [
    ...
    ...(currentUser?.role === "Administrador"
      ? [
          ...
          { href: "/dashboard/sincronizacao-tabela-precos", label: "Sincronização Tabela Preços", icon: RefreshCw },
          { href: "/dashboard/sincronizacao-excecao-preco", label: "Sincronização Exceção Preço", icon: RefreshCw },
          { href: "/dashboard/sincronizacao-cabecalho-nota", label: "Sincronização Cabeçalho Nota", icon: RefreshCw },
          { href: "/dashboard/sincronizacao-financeiro", label: "Sincronização Financeiro", icon: RefreshCw },
          { href: "/dashboard/sincronizacao-vendedores", label: "Sincronização Vendedores", icon: RefreshCw },
          { href: "/dashboard/logs-sincronizacao", label: "Logs de Sincronização", icon: LayoutGrid },
        ]
      : []),
  ]
